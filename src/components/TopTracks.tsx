...
export default function TopTracks({ accessToken }: TopTracksProps) {
    ...
    return (
        <div className="max-w-6xl mx-auto">
            ...
            {!tracks.length && !error && <p className="text-gray-300 text-sm text-center">Loading...</p>}
                    ...
                    <div className="flex space-x-4">
                        {tracks.map((track, index) => (
                            ...
                            >
                                ...
                                <p className="text-sm text-white/70 mb-1">{track.artists.map(a => a.name).join(', ')}</p>
