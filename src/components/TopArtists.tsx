...
export default function TopArtists({ accessToken }: TopArtistsProps) {
    ...
    return (
        <div className="max-w-6xl mx-auto">
            ...
            {!artists.length && !error && <p className="text-gray-300 text-sm text-center">Loading...</p>}
                            ...
                            >
                                ...
                                <div className="mt-2 group relative">
                                    ...
                                    <div className="w-full bg-white/20 rounded-full h-2 overflow-hidden">
                                        ...
                                        <div
                                            className={`${getPopularityColor(artist.popularity)} h-2 rounded-full transition-all duration-700 ease-out`}
